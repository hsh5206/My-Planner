...
export default class Calender {
  ...
  constructor() {
    ...
    this.left_button.addEventListener('click',() => {this.yearChange(-1)});
    this.right_button.addEventListener('click',() => {this.yearChange(+1)});
  }
  ...
  monthClick = (e) => {
    const arr = ['01월','02월','03월','04월','05월','06월','07월','08월','09월','10월','11월','12월'];
  ...
  tableClick = (e) =>  {
    ...
    if (temp) {temp.classList.remove('checked');}
